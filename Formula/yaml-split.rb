...
class YamlSplit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/featherbread/yaml-split/releases/download/v0.1.8/yaml-split-aarch64-apple-darwin.tar.gz"
      sha256 "717768bba25389b2ed275e7bb163a7772b5545584f2950a135efb784352c4c1f"
    end

    if Hardware::CPU.intel?
      url "https://github.com/featherbread/yaml-split/releases/download/v0.1.8/yaml-split-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/featherbread/yaml-split/releases/download/v0.1.8/yaml-split-x86_64-unknown-linux-musl.tar.gz"
      sha256 "8b767adbe555445dc5f9d9611814c8931c9c7a275cbe9d1179fd2d7e6f90d110"
    end

    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/featherbread/yaml-split/releases/download/v0.1.8/yaml-split-aarch64-unknown-linux-musl.tar.gz"
      sha256 "0e52a3ff1c3eeb9393fca805910043bdc3e003922664df4469f637d892636c19"
    end

    if Hardware::CPU.arm? && !Hardware::CPU.is_64_bit?
      url "https://github.com/featherbread/yaml-split/releases/download/v0.1.8/yaml-split-armv7-unknown-linux-musleabihf.tar.gz"
